...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f8fc] lg:bg-white">
      <div className="mx-auto min-h-screen max-w-[1600px] lg:grid lg:grid-cols-[46%_54%]">
        <section className="flex min-h-screen items-center bg-white px-5 py-8 sm:px-8 lg:px-14 xl:px-20">
          <div className="mx-auto w-full max-w-[424px]">
            <div className="mb-10">
              <span className="text-[12px] font-black uppercase tracking-[0.18em] text-slate-900">Falisha</span>
            </div>

            <h1 className="text-[2.1rem] font-bold tracking-[-0.04em] text-slate-900 sm:text-[2.5rem]">
              Welcome back
            </h1>
            ...
            <div className="mt-10">
              <p className="mb-4 text-[0.96rem] font-medium text-slate-600">I am signing in as:</p>
              <div className="grid grid-cols-2 gap-3 rounded-[18px] bg-slate-50 p-1.5">
                <button
                  type="button"
                  onClick={() => setPortalType('individual')}
                  className={`inline-flex items-center justify-center gap-2 rounded-[14px] px-4 py-4 text-[1rem] font-semibold transition-all ${
                    !isAgency
                      ? 'bg-[#1da1f2] text-white shadow-[0_18px_35px_rgba(29,161,242,0.28)]'
            ...
            <form onSubmit={handleSubmit} noValidate className="mt-8 space-y-5">
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center rounded-[16px] bg-[#1da1f2] px-5 py-4 text-[1.02rem] font-semibold text-white shadow-[0_18px_34px_rgba(29,161,242,0.28)] transition hover:bg-[#1093e2] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {isLoading ? (
            ...
            <button
              ...
              className="mt-5 inline-flex w-full items-center justify-center gap-3 rounded-[16px] border border-slate-200 bg-white px-5 py-4 text-[1rem] font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
            >
        ...
        <section className="relative overflow-hidden bg-[linear-gradient(180deg,#2494df_0%,#1b7fd7_26%,#2359d3_68%,#2142b8_100%)] px-5 py-8 text-white sm:px-8 lg:px-10 xl:px-14">
          ...
          <div className="relative mx-auto flex h-full max-w-[720px] flex-col">
            ...
            <div className="mt-10 rounded-[34px] bg-white/95 p-3 text-slate-900 shadow-[0_28px_80px_rgba(6,32,89,0.22)] backdrop-blur sm:p-5 xl:mt-14">
              <div className="rounded-[28px] bg-[#f8fafc] shadow-inner shadow-slate-100">
                <div className="flex items-center gap-3 rounded-t-[28px] border-b border-slate-100 bg-white px-4 py-3 sm:px-6">
                  <div className="flex gap-2">
                    <span className="h-3 w-3 rounded-full bg-[#ff6b6b]" />
                    <span className="h-3 w-3 rounded-full bg-[#ffd84d]" />
                    <span className="h-3 w-3 rounded-full bg-[#67d17b]" />
                  </div>
                  <div className="ml-2 flex-1 rounded-xl bg-slate-50 px-4 py-2 text-xs text-slate-500">
                    falishajobs.up.railway.app/dashboard
                  </div>
                </div>

                <div className="rounded-b-[28px] overflow-hidden">
                  <div className="flex items-center justify-between gap-4 border-b border-white/30 bg-white px-4 py-4 sm:px-6">
                  ...
                  <div className="bg-[linear-gradient(180deg,#1f9cf0_0%,#2577ee_100%)] px-4 py-6 sm:px-8">
                    <div className="flex items-start gap-3 text-white">
                      <div className="mt-1 text-xl">✈️</div>
                      <div>
                        <p className="text-[1.6rem] font-bold tracking-[-0.03em]">FalishaMove → Partner Portal</p>
                        <p className="mt-2 text-[1.02rem] text-blue-100">Welcome back! Continue your relocation journey.</p>
                      </div>
                    </div>

                    <div className="mt-7 rounded-[28px] bg-white px-5 py-6 text-slate-900 shadow-[0_18px_40px_rgba(7,59,133,0.12)] sm:px-6">
                  ...
                  <div className="grid gap-3 bg-white px-4 py-4 sm:grid-cols-2 sm:px-6 sm:py-5">
                    ...
                    <button className="inline-flex items-center justify-center gap-3 rounded-[18px] bg-[#eef7ff] px-5 py-4 text-left text-slate-700 transition hover:bg-[#e4f2ff]">
                      <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#1da1f2] text-white">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4 xl:mt-auto">
              {heroStats.map(({ value, label }) => (
                <div key={label} className="border-t border-white/20 pt-4 text-center sm:text-left">
                  <p className="text-[2rem] font-bold tracking-[-0.04em] text-white">{value}</p>
