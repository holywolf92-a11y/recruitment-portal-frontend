      ...
      {activeMenu === 'browser' ? (
        ...
        <>
          ...
          <section className="mb-4">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Candidate Browser</h1>
          ...
          {dailyStats && (
            <div className="flex gap-3 overflow-x-auto pb-2">
              <div className="min-w-[200px] flex-1 bg-gradient-to-br from-indigo-50 to-indigo-100 border border-indigo-200 rounded-lg p-4 shadow-sm">
              ...
              <div className="min-w-[200px] flex-1 bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-lg p-4 shadow-sm">
              ...
              <div className="min-w-[200px] flex-1 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 shadow-sm">
              ...
              <div className="min-w-[200px] flex-1 bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4 shadow-sm">
              ...
              <div className="min-w-[200px] flex-1 bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-4 shadow-sm">
              ...
              <div className="min-w-[200px] flex-1 bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-lg p-4 shadow-sm">
